...
//   }
//   console.log(`There was a total of ${players.length} goals!`);
// };
...
// team1 === team2 && console.log('A draw is likely');
/* 
///////////////////////////////////////
// Coding Challenge #3
...
for (const [minute, event] of gameEvents) console.log(`${minute <= 45 ? '[FIRST HALF]' : '[SECOND HALF]'} ${minute}: ${event}`);
